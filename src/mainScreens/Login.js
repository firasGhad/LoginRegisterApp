      ...
      <View style={styles.container}>
        ...
        <View>
          <TouchableOpacity title='כניסה' style={styles.appButtonContainer} onPress={this.onLoginPressHandler} >
            <Text style={styles.appButtonText}>כניסה</Text></TouchableOpacity>
          <TouchableOpacity title='הרשמה' style={styles.appButtonContainer} onPress={this.onSignUpDetailsPressHandler}>
            ...
            <TouchableOpacity title='הרשמה' style={styles.appButtonContainer} onPress={this.onResetPasswordPressHandler}>
            <Text style={styles.appButtonText}>שחזור סיסמה</Text></TouchableOpacity>
        </View>
      </View>
    )
  }
